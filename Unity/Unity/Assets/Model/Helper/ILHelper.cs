...
namespace ETModel
{
	public static class ILHelper
	{
		public static void InitILRuntime(ILRuntime.Runtime.Enviorment.AppDomain appdomain)
		{
            ...
            appdomain.DelegateManager.RegisterFunctionDelegate<bool, bool>();
            appdomain.DelegateManager.RegisterDelegateConvertor<Predicate<bool>>((act) =>
            {
                return new Predicate<bool>((obj) =>
                {
                    return ((Func<bool, bool>)act)(obj);
                });
            });
