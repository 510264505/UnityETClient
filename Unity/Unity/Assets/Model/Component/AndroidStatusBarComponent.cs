...
{
    [ObjectSystem]
    public class AndroidStatusBarComponentAwake : AwakeSystem<AndroidStatusBarComponent>
    {
        public override void Awake(AndroidStatusBarComponent self)
        {
            self.Awake();
        }
    }
    public class AndroidStatusBarComponent : Component
    {
        //[Tooltip("状态栏是否显示状态及通知")]
        private bool statusBar;
        //[Tooltip("状态栏样式")]
        private AndroidStatusBar.States states = AndroidStatusBar.States.VisibleOverContent;
        public void Awake()
        {
